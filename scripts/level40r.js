 ...
 * Level 40: for Loops
 * 
 * This file demonstrates for loops in JavaScript.
...
for (let i = 0; i < word.length; i++) {
    console.log("Character at", i, ":", word[i]);
}
...
const QUIZ_QUESTIONS = [
    {
        id: 1,
        question: 'What is the first part of a for loop called?',
        options: [
            "Condition",
            "Initialization",
            "Increment",
        ...
        correct: 1,
        explanation: 'The first part is the initialization, which runs once before the loop starts.'
    },
    {
        id: 2,
        question: 'What is the second part of a for loop called?',
        options: [
            "Initialization",
            "Increment",
            "Condition",
        ...
        correct: 2,
        explanation: 'The second part is the condition, which is checked before each iteration.'
    },
    {
        id: 3,
        question: 'What is the third part of a for loop called?',
        options: [
            "Initialization",
            "Condition",
            "Increment",
        ...
        correct: 2,
        explanation: 'The third part is the increment, which runs after each iteration.'
    },
    {
        id: 4,
        ...
        correct: 1,
        explanation: 'The loop runs for i = 0, 1, 2, 3, 4 (5 times total).'
    },
    {
        id: 5,
        ...
        correct: 0,
        explanation: 'i++ increments i by 1 (adds 1 to i).'
    },
    {
        id: 6,
        ...
        correct: 0,
        explanation: 'The loop outputs 0, 1, 2 (i goes from 0 to 2).'
    },
    {
        id: 7,
    ...
    {
        id: 10,
        question: 'How many times does this loop run? for(let i=5; i>0; i--)',
        options: [
            "4",
            "5",
            "6",
        ...
        correct: 1,
        explanation: 'The loop runs for i = 5, 4, 3, 2, 1 (5 times total).'
    },
    {
        id: 11,
        ...
        correct: 1,
        explanation: 'When i=1, continue skips the log, so only 0 and 2 are output.'
    },
    {
        id: 12,
        question: 'What is the output of: for(let i=0; i<3; i++) { if(i===1) break; console.log(i); }',
        options: [
            "0 1 2",
            "0",
            "0 1",
        ...
        correct: 1,
        explanation: 'When i=1, break exits the loop, so only 0 is output.'
    },
    {
        id: 13,
        question: 'Which loop runs from 0 to 9?',
        options: [
            "for(let i=0; i<10; i++)",
            "for(let i=0; i<=10; i++)",
            "for(let i=1; i<10; i++)",
        ...
        correct: 0,
        explanation: 'for(let i=0; i<10; i++) runs for i = 0 to 9 (10 times).'
    },
    {
        id: 14,
        ...
        correct: 1,
        explanation: 'i-- decrements i by 1 (subtracts 1 from i).'
    },
    {
        id: 15,
        question: 'What is the output of: for(let i=0; i<5; i+=2) { console.log(i); }',
        options: [
            "0 2 4",
            "0 1 2 3 4",
            "2 4",
        ...
        correct: 0,
        explanation: 'i += 2 means step by 2, so the output is 0, 2, 4.'
    }
];
...
function endQuiz(timeUp = false) {
    ...
    if (passed) {
        message += ' 🌟 Perfect score! You\'ve mastered for loops!';
    } else if (timeUp) {
