/**
 * Level 67: Counter App
 * 
 * This file implements a counter application.
...
class CounterApp {
    ...
    loadState() {
        let saved = localStorage.getItem("counterState");
        if (saved) {
            try {
    ...
    render() {
        ...
        if (this.history.length === 0) {
            historyList.textContent = "No changes yet";
        } else {
            let html = "";
            this.history.forEach(item => {
                ...
                html += `<span class="${className}">${item.action} → ${item.value}</span>`;
            });
...
const QUIZ_QUESTIONS = [
    {
        id: 1,
        question: 'What does the increment() method do?',
        options: [
            "Increases the counter by 1",
            "Decreases the counter by 1",
            "Resets the counter to 0",
            "Saves the counter state"
        ],
        correct: 0,
        explanation: 'increment() increases the counter by 1.'
    },
    {
        id: 2,
        question: 'What does the decrement() method do?',
        options: [
            "Decreases the counter by 1",
            "Increases the counter by 1",
            "Resets the counter to 0",
        ...
        correct: 0,
        explanation: 'decrement() decreases the counter by 1.'
    },
    {
        id: 3,
        question: 'What does the reset() method do?',
        options: [
            "Resets the counter to 0",
            "Increases the counter by 1",
            "Decreases the counter by 1",
        ...
        correct: 0,
        explanation: 'reset() resets the counter to 0.'
    },
    {
        id: 4,
        question: 'What color is the counter when the value is positive?',
        options: [
            "Green",
            "Red",
            "Yellow",
        ...
        correct: 0,
        explanation: 'The counter is green (--accent-sql) when positive.'
    },
    {
        id: 5,
        question: 'What color is the counter when the value is negative?',
        options: [
            "Red",
            "Green",
            "Yellow",
        ...
        correct: 0,
        explanation: 'The counter is red (--accent-html) when negative.'
    },
    {
        id: 6,
        question: 'What is the output: let app = new CounterApp(); app.increment(); console.log(app.count);',
        options: [
            "1",
            "0",
            "undefined",
        ...
        correct: 0,
        explanation: 'After increment, the count is 1.'
    },
    {
        id: 7,
        question: 'What is the output: let app = new CounterApp(); app.increment(); app.increment(); app.decrement(); console.log(app.count);',
        options: [
            "1",
            "2",
            "3",
        ...
        correct: 0,
        explanation: '1 + 1 - 1 = 1, so the count is 1.'
    },
    {
        id: 8,
        question: 'What is the output: let app = new CounterApp(); app.increment(); app.reset(); console.log(app.count);',
        options: [
            "0",
            "1",
            "undefined",
        ...
        correct: 0,
        explanation: 'After increment and reset, the count is 0.'
    },
    {
        id: 9,
        question: 'Where is the counter state saved?',
        options: [
            "localStorage",
            "sessionStorage",
            "A database",
        ...
        correct: 0,
        explanation: 'The counter state is saved in localStorage.'
    },
    {
        id: 10,
        question: 'What is the output: let app = new CounterApp(); app.increment(); app.increment(); app.increment(); console.log(app.count);',
        options: [
            "3",
            "2",
            "1",
        ...
        correct: 0,
        explanation: 'After three increments, the count is 3.'
    },
    {
        id: 11,
        question: 'What is the output: let app = new CounterApp(); app.decrement(); app.decrement(); app.decrement(); console.log(app.count);',
        options: [
            "-3",
            "-2",
            "-1",
        ...
        correct: 0,
        explanation: 'After three decrements, the count is -3.'
    },
    {
        id: 12,
        question: 'What is the output: let app = new CounterApp(); app.increment(); app.decrement(); app.increment(); app.decrement(); console.log(app.count);',
        options: [
            "0",
            "1",
            "-1",
        ...
        correct: 0,
        explanation: '1 - 1 + 1 - 1 = 0, so the count is 0.'
    },
    {
        id: 13,
        question: 'What is the output: let app = new CounterApp(); app.increment(); app.increment(); app.reset(); app.increment(); console.log(app.count);',
        options: [
            "1",
            "2",
            "0",
        ...
        correct: 0,
        explanation: 'After increment, increment, reset, increment, the count is 1.'
    },
    {
        id: 14,
        question: 'What is the output: let app = new CounterApp(); console.log(app.history.length);',
        options: [
            "0",
            "1",
            "2",
        ...
        correct: 0,
        explanation: 'Initially, the history is empty, so length is 0.'
    },
    {
        id: 15,
        question: 'What keyboard shortcut increments the counter?',
        options: [
            "ArrowUp or +",
            "ArrowDown or -",
            "R",
        ...
        correct: 0,
        explanation: 'The counter can be incremented using ArrowUp or + keys.'
    }
];
...
function endQuiz(timeUp = false) {
    ...
    if (passed) {
        message += ' 🌟 Perfect score! You\'ve mastered the Counter app!';
    } else if (timeUp) {
