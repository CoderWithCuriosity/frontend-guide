/**
 * Level 65: Classes Basics
 * 
 * This file demonstrates classes in JavaScript.
...
console.log("John:", john.name, john.age);
console.log("Jane:", jane.name, jane.age);
console.log("John says:", john.greet());
...
console.log("Start car 1:", car1.start());
console.log("Is running:", car1.isRunning);
console.log("Stop car 1:", car1.stop());
console.log("Is running:", car1.isRunning);
...
class User {
    constructor(name, age = 18, city = "Unknown") {
        this.name = name;
        this.age = age;
        this.city = city;
...
let user1 = new User("Alice", 25, "New York");
let user2 = new User("Bob"); // Uses default values

console.log("User 1:", user1.getInfo());
console.log("User 2:", user2.getInfo());
console.log("User 1 created:", user1.createdAt);
...
const QUIZ_QUESTIONS = [
    ...
    },
    {
        ...
        correct: 0,
        explanation: 'The constructor method is called when creating a new instance of a class.'
    },
    {
        id: 3,
        ...
        correct: 0,
        explanation: 'The "new" keyword is used to create a new instance of a class.'
    },
    {
        id: 4,
        question: 'What does "this" refer to in a class?',
        options: [
    ...
    {
        id: 5,
        question: 'What is the output: class Person { constructor(name) { this.name = name; } } let p = new Person("John"); console.log(p.name);',
        options: [
            "John",
            "name",
            "undefined",
        ...
        correct: 0,
        explanation: 'p.name accesses the name property, which is "John".'
    },
    {
        id: 6,
        question: 'What is the output: class Dog { bark() { return "Woof"; } } let d = new Dog(); console.log(d.bark());',
        options: [
            "Woof",
            "undefined",
            "Error",
        ...
        correct: 0,
        explanation: 'd.bark() calls the bark method, which returns "Woof".'
    },
    {
        id: 7,
        question: 'Can a class have multiple methods?',
        options: [
            "Yes",
            "No",
        ...
        correct: 0,
        explanation: 'Yes, a class can have multiple methods.'
    },
    {
        id: 8,
        question: 'What is the output: class Car { constructor(brand) { this.brand = brand; } } let c = new Car("Toyota"); console.log(c.brand);',
        options: [
            "Toyota",
            "brand",
            "undefined",
        ...
        correct: 0,
        explanation: 'c.brand accesses the brand property, which is "Toyota".'
    },
    {
        id: 9,
        question: 'What is the output: class User { constructor(name) { this.name = name; } } let u1 = new User("Alice"); let u2 = new User("Bob"); console.log(u1.name + " " + u2.name);',
        options: [
            "Alice Bob",
            "Alice",
            "Bob",
        ...
        correct: 0,
        explanation: 'u1.name is "Alice" and u2.name is "Bob", so the output is "Alice Bob".'
    },
    {
        id: 10,
        question: 'What is the output: class Person { constructor(name) { this.name = name; } greet() { return "Hello"; } } let p = new Person("John"); console.log(p.greet());',
        options: [
            "Hello",
            "Hello John",
            "undefined",
        ...
        correct: 0,
        explanation: 'p.greet() calls the greet method, which returns "Hello".'
    },
    {
        id: 11,
        question: 'What is the output: class Animal { constructor(type) { this.type = type; } } let a = new Animal("Dog"); console.log(a.type);',
        options: [
            "Dog",
            "type",
            "undefined",
        ...
        correct: 0,
        explanation: 'a.type accesses the type property, which is "Dog".'
    },
    {
        id: 12,
        question: 'What is the output: class Product { constructor(name, price) { this.name = name; this.price = price; } } let p = new Product("Laptop", 999); console.log(p.name + " $" + p.price);',
        options: [
            "Laptop $999",
            "Laptop",
            "999",
        ...
        correct: 0,
        explanation: 'p.name is "Laptop" and p.price is 999, so the output is "Laptop $999".'
    },
    {
        id: 13,
        question: 'What is the output: class Student { constructor(name) { this.name = name; } } let s = new Student("John"); console.log(s.name + " is a student");',
        options: [
            "John is a student",
            "name is a student",
            "undefined is a student",
            "Error"
        ],
        correct: 0,
        explanation: 's.name is "John", so the output is "John is a student".'
    },
    {
        id: 14,
        question: 'What is the output: class Book { constructor(title) { this.title = title; } } let b = new Book("1984"); console.log(b.title);',
        options: [
            "1984",
            "title",
            "undefined",
        ...
        correct: 0,
        explanation: 'b.title accesses the title property, which is "1984".'
    },
    {
        id: 15,
        question: 'What is the output: class Animal { constructor(name) { this.name = name; } speak() { return "I am an animal"; } } let a = new Animal("Dog"); console.log(a.speak());',
        options: [
            "I am an animal",
            "I am a Dog",
            "undefined",
        ...
        correct: 0,
        explanation: 'a.speak() calls the speak method, which returns "I am an animal".'
    }
];
...
function endQuiz(timeUp = false) {
    ...
    if (passed) {
        message += ' 🌟 Perfect score! You\'ve mastered classes basics!';
    } else if (timeUp) {
