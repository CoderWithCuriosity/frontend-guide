...
console.log("Before:", demoText.textContent);
demoText.textContent = "This text was changed by JavaScript!";
console.log("After:", demoText.textContent);
...
demoText.style.color = "#f0c674";
demoText.style.fontSize = "1.8rem";
demoText.style.fontWeight = "700";
demoText.style.borderLeft = "4px solid #8ec07c";
demoText.style.paddingLeft = "12px";

items.forEach((item, index) => {
    item.style.backgroundColor = "#23233a";
    item.style.padding = "8px 12px";
    item.style.borderRadius = "4px";
    item.style.borderLeft = "3px solid #7ec8e3";
...
demoText.setAttribute("data-status", "modified");
demoText.setAttribute("title", "This element was modified by JavaScript");

console.log('data-status =', demoText.getAttribute("data-status"));
console.log('title =', demoText.getAttribute("title"));
...
demoText.removeAttribute("data-status");
console.log('data-status after removal =', demoText.getAttribute("data-status"));
...
demoText.classList.add("modified");
console.log("Class list:", demoText.classList);

demoText.classList.remove("highlight");
console.log("After removing 'highlight':", demoText.classList);

demoText.classList.toggle("active");
console.log("After toggling 'active':", demoText.classList);
...
newElement.textContent = "This paragraph was created by JavaScript!";
newElement.style.color = "#b58aef";
newElement.style.padding = "8px 12px";
newElement.style.backgroundColor = "#1b1b29";
newElement.style.borderRadius = "4px";
newElement.style.marginTop = "8px";

demoBox.appendChild(newElement);
...
let removeElement = document.querySelector(".demo-item:last-child");
if (removeElement) {
    console.log("Removing element:", removeElement.textContent);
    removeElement.remove();
}

// ============================================
// CHANGING INNER HTML (USE CAREFULLY)
// ============================================
...
container.innerHTML = `
    <p style="color: #7ec8e3; padding: 8px; background: #1b1b29; border-radius: 4px;">
        This was added with innerHTML!
    </p>
`;
demoBox.appendChild(container);
...
const QUIZ_QUESTIONS = [
    {
        ...
        correct: 0,
        explanation: 'textContent gets or sets the text content of an element.'
    },
    {
        id: 2,
    ...
    },
    {
        ...
        correct: 0,
        explanation: 'setAttribute() sets an attribute on an element.'
    },
    {
        id: 4,
        question: 'What is the correct syntax for textContent?',
        options: [
        ...
        correct: 0,
        explanation: 'Use element.textContent = "text" to set text content.'
    },
    {
        id: 5,
    ...
    {
        id: 6,
        question: 'What does classList.remove() do?',
        options: [
            "Adds a CSS class to an element",
            "Removes a CSS class from an element",
            "Toggles a CSS class on an element",
        ...
        correct: 1,
        explanation: 'classList.remove() removes a CSS class from an element.'
    },
    {
        id: 7,
        ...
        correct: 2,
        explanation: 'classList.toggle() adds the class if it\'s not present, removes it if it is.'
    },
    {
        id: 8,
        question: 'What is the output: let el = document.getElementById("demo"); el.textContent = "Hello"; console.log(el.textContent);',
        options: [
            "Hello",
            "demo",
            "undefined",
        ...
        correct: 0,
        explanation: 'textContent is set to "Hello", so the output is "Hello".'
    },
    {
        id: 9,
        ...
        correct: 0,
        explanation: 'Use document.createElement("p") to create a new element.'
    },
    {
        id: 10,
        question: 'How do you add a new element to the page?',
        options: [
            "parent.appendChild(newElement)",
            "parent.add(newElement)",
            "parent.insert(newElement)",
            "parent.place(newElement)"
        ],
        correct: 0,
        explanation: 'Use parent.appendChild(newElement) to add a new element.'
    },
    {
        id: 11,
        question: 'What does removeAttribute() do?',
        options: [
            "Removes an attribute from an element",
            "Sets an attribute on an element",
            "Gets an attribute from an element",
        ...
        correct: 0,
        explanation: 'removeAttribute() removes an attribute from an element.'
    },
    {
        id: 12,
        question: 'What is the difference between textContent and innerHTML?',
        options: [
            "textContent is for text, innerHTML is for HTML",
            "They are the same",
            "innerHTML is for text, textContent is for HTML",
            "textContent is for attributes"
        ],
        correct: 0,
        explanation: 'textContent is for text only, innerHTML allows HTML content.'
    },
    {
        id: 13,
        question: 'What is the output: let el = document.getElementById("demo"); el.remove(); console.log(el);',
        options: [
            "null",
            "undefined",
            "The element object",
        ...
        correct: 0,
        explanation: 'After remove(), the element is removed from the DOM and becomes null.'
    },
    {
        id: 14,
        question: 'Can you change multiple styles at once?',
        options: [
            "Yes, using style.cssText",
            "No, you can only change one at a time",
            "Only with jQuery",
            "Only if they are inline styles"
        ],
        correct: 0,
        explanation: 'You can use style.cssText = "color: red; font-size: 20px;" to change multiple styles.'
    },
    {
        id: 15,
        question: 'What is the output: let el = document.getElementById("demo"); el.className = "newClass"; console.log(el.className);',
        options: [
            "newClass",
            "demo",
            "undefined",
        ...
        correct: 0,
        explanation: 'className sets the class attribute to "newClass".'
    }
];
...
function endQuiz(timeUp = false) {
    ...
    if (passed) {
        message += ' 🌟 Perfect score! You\'ve mastered DOM manipulation!';
    } else if (timeUp) {
