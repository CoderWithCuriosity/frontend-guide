/**
 * Level 36: if/else Statements
 * 
 * This file demonstrates if/else statements in JavaScript.
...
if (isLoggedIn) {
    ...
    if (hasPermission) {
        console.log("User has permission to access");
    } else {
...
console.log('"Alice" === "Alice":', "Alice" === "Alice");
console.log('"Alice" === "alice":', "Alice" === "alice");
...
const QUIZ_QUESTIONS = [
    {
        ...
        correct: 0,
        explanation: 'Since x = 5 and 5 > 3 is true, the if block executes and prints "Yes".'
    },
    {
        id: 2,
    ...
    {
        id: 3,
        question: 'What will this code output? let age = 16; if (age >= 18) { console.log("Adult"); } else { console.log("Minor"); }',
        options: [
            "Adult",
            "Minor",
            "Error",
        ...
        correct: 1,
        explanation: 'Since age = 16 and 16 >= 18 is false, the else block runs and prints "Minor".'
    },
    {
        id: 4,
        ...
        correct: 0,
        explanation: 'The correct syntax is if (condition) { code }. The condition must be in parentheses.'
    },
    {
        id: 5,
        question: 'What will this code output? let score = 75; if (score >= 80) { console.log("A"); } else if (score >= 70) { console.log("B"); } else { console.log("C"); }',
        options: [
            "A",
            "B",
            "C",
        ...
        correct: 1,
        explanation: 'score = 75, so it\'s not >= 80 (A), but it is >= 70 (B), so it prints "B".'
    },
    {
        id: 6,
        question: 'What operator is used for "greater than or equal to"?',
        options: [
            ">",
            "<",
            ">=",
    ...
    {
        id: 7,
        question: 'What will this code output? let isLoggedIn = false; if (isLoggedIn) { console.log("Welcome"); } else { console.log("Please login"); }',
        options: [
            "Welcome",
            "Please login",
            "Error",
        ...
        correct: 1,
        explanation: 'Since isLoggedIn is false, the else block runs and prints "Please login".'
    },
    {
        id: 8,
        ...
        correct: 0,
        explanation: 'A nested if statement is an if statement placed inside another if statement.'
    },
    {
        id: 9,
        question: 'What will this code output? let num = 4; if (num % 2 === 0) { console.log("Even"); } else { console.log("Odd"); }',
        options: [
            "Even",
            "Odd",
            "Error",
        ...
        correct: 0,
        explanation: '4 % 2 === 0 is true, so the if block runs and prints "Even".'
    },
    {
        id: 10,
        ...
        correct: 2,
        explanation: '=== checks both value and type equality. It returns true only if both are the same.'
    },
    {
        id: 11,
        question: 'What will this code output? let x = 10; let y = "10"; if (x == y) { console.log("Equal"); } else { console.log("Not equal"); }',
        options: [
            "Equal",
            "Not equal",
            "Error",
        ...
        correct: 0,
        explanation: '== checks value equality, and 10 == "10" is true (type coercion), so it prints "Equal".'
    },
    {
        id: 12,
        question: 'What will this code output? let x = 10; let y = "10"; if (x === y) { console.log("Equal"); } else { console.log("Not equal"); }',
        ...
        correct: 1,
        explanation: '=== checks value and type equality. 10 (number) !== "10" (string), so it prints "Not equal".'
    },
    {
        id: 13,
        ...
        correct: 0,
        explanation: '5 > 3 is true AND 10 < 20 is true. Both are true, so the result is true.'
    },
    {
        id: 14,
        question: 'What is the result of: 5 > 3 || 10 > 20?',
        ...
        correct: 0,
        explanation: '5 > 3 is true OR 10 > 20 is false. Since at least one is true, the result is true.'
    },
    {
        id: 15,
        question: 'What will this code output? let temperature = 30; if (temperature > 30) { console.log("Hot"); } else if (temperature > 20) { console.log("Warm"); } else { console.log("Cold"); }',
        options: [
            "Hot",
            "Warm",
            "Cold",
        ...
        correct: 1,
        explanation: 'temperature = 30. It\'s not > 30 (Hot), but it is > 20 (Warm), so it prints "Warm".'
    }
];
...
function endQuiz(timeUp = false) {
    ...
    if (passed) {
        message += ' 🌟 Perfect score! You\'ve mastered if/else statements!';
    } else if (timeUp) {
