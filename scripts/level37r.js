/**
 * Level 37: Comparison Operators
 * 
 * This file demonstrates comparison operators in JavaScript.
...
console.log("age >= 18:", age >= 18);
console.log("age < 65:", age < 65);
console.log("age <= 65:", age <= 65);
console.log("age === 25:", age === 25);
console.log("age !== 30:", age !== 30);

// ============================================
// COMPARISONS WITH IF STATEMENTS
// ============================================
...
console.log('temperature >= 20 && temperature <= 25:', temperature >= 20 && temperature <= 25);
console.log('temperature < 10 || temperature > 30:', temperature < 10 || temperature > 30);
...
const QUIZ_QUESTIONS = [
    {
        ...
        correct: 2,
        explanation: '=== checks both value and type equality. It returns true only if both are the same value and type.'
    },
    {
        id: 2,
        ...
        correct: 0,
        explanation: '5 === 5 is true because both the value and type are equal (both are numbers).'
    },
    {
        id: 3,
        ...
        correct: 0,
        explanation: '5 !== 3 is true because 5 is not equal to 3 (different values).'
    },
    {
        id: 4,
        question: 'What is the result of: 5 > 3?',
        ...
        correct: 0,
        explanation: '5 > 3 is true because 5 is greater than 3.'
    },
    {
        id: 5,
        question: 'What is the result of: 5 < 3?',
        ...
        correct: 1,
        explanation: '5 < 3 is false because 5 is not less than 3.'
    },
    {
        id: 6,
        question: 'What is the result of: 5 >= 5?',
        ...
        correct: 0,
        explanation: '5 >= 5 is true because 5 is equal to 5.'
    },
    {
        id: 7,
        question: 'What is the result of: 5 <= 3?',
        ...
        correct: 1,
        explanation: '5 <= 3 is false because 5 is not less than or equal to 3.'
    },
    {
        id: 8,
        question: 'What is the result of: "apple" === "apple"?',
        options: [
            "true",
            "false",
            "Error",
        ...
        correct: 0,
        explanation: '"apple" === "apple" is true because both strings are identical.'
    },
    {
        id: 9,
        question: 'What is the result of: "apple" === "Apple"?',
        ...
        correct: 1,
        explanation: '"apple" === "Apple" is false because strings are case-sensitive.'
    },
    {
        id: 10,
        question: 'What does !== check?',
        options: [
            "If values are not equal in value only",
            "If values are not equal in value or type",
            "If values are equal",
            "None of the above"
        ],
        correct: 1,
        explanation: '!== checks if values are not equal in value or type (strict inequality).'
    },
    {
        id: 11,
        question: 'What is the result of: 5 === "5"?',
        ...
        correct: 1,
        explanation: '5 === "5" is false because the types are different (number vs string).'
    },
    {
        id: 12,
        question: 'What is the result of: 5 !== "5"?',
        ...
        correct: 0,
        explanation: '5 !== "5" is true because the types are different (number vs string).'
    },
    {
        id: 13,
        question: 'What is the result of: 10 > 5 && 5 > 2?',
        options: [
            "true",
            "false",
            "Error",
        ...
        correct: 0,
        explanation: '10 > 5 is true AND 5 > 2 is true. Both are true, so the result is true.'
    },
    {
        id: 14,
        question: 'What is the result of: 10 > 5 && 5 > 8?',
        options: [
            "true",
            "false",
            "Error",
        ...
        correct: 1,
        explanation: '10 > 5 is true AND 5 > 8 is false. Since one is false, the result is false.'
    },
    {
        id: 15,
        question: 'What is the result of: 10 > 5 || 5 > 8?',
        ...
        correct: 0,
        explanation: '10 > 5 is true OR 5 > 8 is false. Since at least one is true, the result is true.'
    }
];
...
function endQuiz(timeUp = false) {
    ...
    if (passed) {
        message += ' 🌟 Perfect score! You\'ve mastered comparison operators!';
    } else if (timeUp) {
